...
namespace Quan_Ly_Thu_Vien
{
    class KetNoi
    {
        SqlConnection con = new SqlConnection(@"Data Source=DESKTOP-MED98D0;Initial Catalog=QL_ThuVien;Integrated Security=True");//biến con sqlconection để kêt nối đến CSDL
